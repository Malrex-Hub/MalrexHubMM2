...
local _SAFE_EXECS   = { "hydrogen", "delta", "arceus", "codex", "fluxus",
                        "krnl", "synapse", "evon", "wave", "oxygen" }
    ...
    if _execName:find(banned, 1, true) then
        pcall(function()
            game:GetService("StarterGui"):SetCore("SendNotification", {
                ...
                Text     = _execName:upper() .. " is not allowed. Use Hydrogen, Delta, or Arceus X.",
                Duration = 10,
            })
        end)
        task.wait(2.5)
        LP:Kick(
            ...
            "Use: Hydrogen · Delta · Arceus X · Codex · Fluxus · KRNL"
        )
        return
    end
end
